...
def grab_col_names(dataframe, cat_th=10, car_th=20):
    ...
    # so our total variables: cat_cols + num_cols + cat_but_car
    # num_but_cat: we do not use this because these variable does not contain any meaningful information for analysis.
